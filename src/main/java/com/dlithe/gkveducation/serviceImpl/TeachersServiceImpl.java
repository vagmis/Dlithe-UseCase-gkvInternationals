...
import com.dlithe.gkveducation.dto.TeachersResponse;
...
public class TeachersServiceImpl implements TeachersService {
    ...
    public ResponseEntity<BaseResponse> findTeacherData(int teacherId) {
        ...
        teachersResponse.setTeacherName(teacherData.getTeacherName());
        teachersResponse.setTeacherPhoto(teacherData.getTeacherPhoto());
        teachersResponse.setTeacherDescription(teacherData.getTeacherDescription());

        baseResponse.setMessage("User found");
        baseResponse.setHttpStatus(HttpStatus.OK);
        baseResponse.setHttpStatusCode(HttpStatus.OK.value());
        baseResponse.setResponse(teachersResponse);
